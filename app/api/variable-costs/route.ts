...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Error in GET /api/variable-costs:", error);
    return NextResponse.json(
...
// POST - Create new variable cost(s)
export async function POST(request: NextRequest) {
  try {
    ...
    if (error) {
      console.error("Error creating variable costs:", error);
      return NextResponse.json({ error: error.message }, { status: 500 });
    }

    return NextResponse.json({ data });
  } catch (error) {
    console.error("Error in POST /api/variable-costs:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
...
// PUT - Update existing variable cost
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error("Error in PUT /api/variable-costs:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (mode === "single") {
      ...
      if (error) {
        console.error("Error deleting future variable costs:", error);
        return NextResponse.json({ error: error.message }, { status: 500 });
      }
    }
    ...
    console.error("Error in DELETE /api/variable-costs:", error);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 }
    );
